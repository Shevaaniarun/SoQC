  ...
  return (
    ...
    >
      ...
      <div
        style={{
          textAlign: "center",
          padding: isMobile ? "20px 16px 24px" : "40px 24px 32px",
          maxWidth: 700,
          margin: "0 auto",
        }}
      >
      ...
      <div
        style={{
          maxWidth: 1200,
          margin: "0 auto",
          padding: isMobile ? "0 12px 20px" : "0 24px 24px",
        }}
      >
        <div
          style={{
      ...
      <div
        style={{
          maxWidth: 1200,
          margin: "0 auto",
          padding: isMobile ? "0 12px 80px" : "0 24px 120px",
        }}
      >
        <AnimatePresence mode="wait">
          ...
          >
            ...
            {filteredAndSorted.length === 0 && (
              ...
              >
                <p style={{ fontSize: isMobile ? 16 : 18, marginBottom: 8 }}>
                  No articles found
                </p>
                <p style={{ fontSize: isMobile ? 12 : 13 }}>
