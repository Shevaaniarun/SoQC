          ...
          <div key={i} style={{ display: "flex", alignItems: "center" }}>
            ...
            {i < nodes.length - 1 && (
              ...
              >
                ...
                <span style={{ color: "rgba(196,181,253,0.5)", fontSize: 10 }}>
                  ▶
                </span>
              </motion.div>
            )}
      ...
      <div style={{ position: "relative", height: 200, overflow: "hidden" }}>
        ...
        <div
          style={{
            ...
            inset: 0,
            background:
              "linear-gradient(to bottom, transparent, rgba(3,3,15,0.9))",
          }}
        />
        <div
          style={{
      ...
      <div style={{ padding: "28px 32px" }}>
        ...
        >
          ...
          <div>
            ...
            <span
              style={{ fontFamily: "Inter", fontSize: 12, color: "#c4b5fd" }}
            >
              {project.guide}
            </span>
          </div>
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          From theoretical research to working quantum systems — our projects
          push the boundaries of what's possible with today's quantum hardware.
        </motion.p>
      </div>
